...
select * from tb_Ogrenci (NOLOCK) order  by 3; /* NOLOCK kayýdý kilitlemez. bir kaç kiþi üzerinde çalýþabilir. */    

select  top 4 * from tb_Ogrenci order by 6 asc; /* 1999 dan baþlayarak ilk 4 ü yazar.*//* ASC X DESC */
select * from tb_Ogrenci where ID BETWEEN 48 AND 56 ORDER BY 1                                              
